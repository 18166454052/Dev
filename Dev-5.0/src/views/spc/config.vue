        ...
        <el-row class="vertical-tabs" >
            <el-col :xs="{span:20,offset:2}" :sm="{span:18,offset:3}"
                :md="{span:16,offset:4}" :lg="{span:16,offset:4}" :xl="{span:16,offset:4}"  style="position:relative" >
                   <el-button  style="position:absolute;left:20px;top:260px;z-index:99" type="success" size="small" :loading="updateLoading"  @click="submit">保存</el-button>
...
export default {
    ...
    methods:{
                        ...
                        if(res){
                            ...
                            if(this.graphType==1){
                                ...
                                return false;
                                    ...
                                    // let data={
                                    //     spcTaskId:this.Form.spcTaskId,
                                    //     configDataanalysisId:this.Form.configDataanalysisId,
                                    //     spcTaskName:this.Form.spcTaskName,
                                    //     controlGraph:this.Form.controlGraph,
                                    //     decimalDigits:this.Form.decimalDigits,
                                    //     recentGroups:this.Form.recentGroups,
                                    //     usl:this.Form.usl,
                                    //     lsl:this.Form.lsl,
                                    ...
                                    //     data.moveRange=this.Form.moveRange;
                                    // }
        ...
        back:function(){
            this.$router.push("/spc/detail/"+ this.spcTaskId);
        },
        allGrouop:function(){
